...
export const getRoomsUrl = `${baseUrl}/list`


export const roomsListMockData = {
  data: [
    {
      address: {
        countryCode: "ae",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/esanjolabs/image/upload/hotels/74181_120226175245711.png",
